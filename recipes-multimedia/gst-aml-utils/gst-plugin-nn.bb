SUMMARY = "aml gst plugs nn, call nnsdk for face detect, and sent result to overlay plugin"
...
RDEPENDS:${PN} += " dma-allocator gst-aml-dma-allocator gst-aml-gfx2d detect-library npu-common libge2d"
