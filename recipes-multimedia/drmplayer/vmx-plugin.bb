...
#For common patches
SRC_URI_append = " ${@get_patch_list_with_path('${AML_PATCH_PATH}/multimedia/libmediadrm/verimatrix')}"
...
VMX_PLUGIN_PATH_sc2 = "m9x4"
VMX_PLUGIN_PATH_s4 = "m9y4"
...
FILES_${PN} += " ${bindir}/* ${libdir}/*.so ${datadir}/mediadrm"
