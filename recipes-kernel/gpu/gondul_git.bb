...
SUMMARY = "Arm G52(gondul) graphic driver"
LICENSE = "GPLv2"
...
EXTRA_OEMAKE='-C ${STAGING_KERNEL_DIR} M=${GPU_DRV_SRC} \
              EXTRA_CFLAGS="-DCONFIG_MALI_MIDGARD_DVFS -DCONFIG_MALI_GATOR_SUPPORT=y \
              -I${S}/${GPU_ARCH}/${VER}/kernel/include -DCONFIG_MALI_LOW_MEM=${GPU_LOW_MEM}" \
              CONFIG_MALI_MIDGARD=m CONFIG_MALI_MIDGARD_DVFS=y CONFIG_MALI_GATOR_SUPPORT=y CONFIG_MALI_PLATFORM_NAME="devicetree" modules'
