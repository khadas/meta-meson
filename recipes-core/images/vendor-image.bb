...
AVB_DMVERITY_PARTITION_SIZE = "${DEVICE_PROPERTY_VENDOR_PARTITION_SIZE}"
AVB_DMVERITY_ROLLBACK_INDEX = "${DEVICE_PROPERTY_VENDOR_ROLLBACK_INDEX}"
AVB_DM_VERITY_PARTITION_NAME = "vendor"
