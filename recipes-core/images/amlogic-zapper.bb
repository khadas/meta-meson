...
IMAGE_INSTALL += " \
    ...
    ${@bb.utils.contains('DISTRO_FEATURES', 'irdeto-dvtapp', 'irdeto-dvtapp', '', d)} \
    ${@bb.utils.contains('DISTRO_FEATURES', 'irdeto-imw', 'irdeto-imw', '', d)} \
...
IMAGE_INSTALL:remove = "\
    ${@bb.utils.contains_any('DISTRO_FEATURES', 'irdeto-dvtapp irdeto-imw', 'arka arka-prebuilt-pkg aml-hdi irdeto-cashal-rel ', '', d)} \
