...
PATH_append_p1 = ":${STAGING_DIR_NATIVE}/riscv-none-gcc/bin"
...
DEPENDS_append = "gcc-linaro-aarch64-none-elf-native gcc-linaro-aarch64-elf-native vim-native zip-native"
...
DEPENDS_append_p1 = " riscv-none-gcc-native "
